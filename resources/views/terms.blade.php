...
@section('title', 'Dallel AI | Terms of Service')
...
<section class="section">
  <div class="container">
    <div class="card card-body">
      <h3>1. Scope</h3><p class="muted">This sample page outlines expected public website terms for Dallel AI. Replace this copy with reviewed legal language before launch.</p>
