...
@section('title', 'Dallel AI | Cookie Policy')
...
<section class="section">
  <div class="container">
    <div class="card card-body">
      <h3>1. Scope</h3><p class="muted">This sample page describes how Dallel AI may use cookies or similar technologies for login, preferences, analytics, and product improvement.</p>
