...
@section('title', 'Dallel AI | Privacy Policy')
...
<section class="section">
  <div class="container">
    <div class="card card-body">
      <h3>1. Scope</h3><p class="muted">Dallel AI should collect only the information needed to personalize learning, operate accounts, support teams, and improve recommendations.</p>
